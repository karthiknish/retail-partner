    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 py-20 relative h-screen">
        ...
        <div className="container relative z-10 mx-auto px-4 py-6 flex flex-col items-center justify-center h-full">
          <div className="text-6xl font-bold text-white text-center mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md relative">
              ...
              <div className="text-center">
                <button
                  ...
                  className="cursor-pointer bg-primary text-white px-6 py-2 rounded-md font-medium hover:bg-red-700 transition-colors"
                >
                  Enquire
                </button>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-gray p-6 rounded-lg shadow-md">
              ...
              <p className="font-primary text-center text-white">
                Supporting restaurants, cafes, and food service businesses with
                specialized equipment, displays, and operational necessities.
              </p>
            </div>
            ...
            <div className="bg-dark-gray p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 font-primary text-center text-white">
                Delivering specialized solutions for medical facilities,
                pharmacies, and healthcare providers with a focus on
            ...
            <div className="bg-dark-gray p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 font-primary text-center text-white">
                Supporting schools, universities, and educational institutions
                with furniture, displays, and equipment that enhance learning
                environments.
              </p>
            </div>
            ...
            <div className="bg-dark-gray p-6 rounded-lg shadow-md">
              ...
              <p className=" font-primary text-center text-white">
                Providing office spaces with furniture, signage, and branded
                elements that reflect company identity and improve workplace
                functionality.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              The Retail Factory is a leading retail consultancy that
              specializes in helping businesses optimize their retail
              operations. With years of industry experience, we understand the
              challenges retailers face and provide tailored solutions to
              overcome them.
            </p>
            <p className="text-gray-600">
              Our team of experts works closely with clients to develop
              strategies that drive growth, improve efficiency, and enhance
              customer experience. We&apos;re committed to your success and
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Develop comprehensive retail strategies to drive growth and
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Optimize your retail operations to reduce costs and improve
                efficiency.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Enhance customer satisfaction and loyalty through improved
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div className="md:flex">
              <div className="md:w-1/2 p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Have questions or ready to start working with us? Fill out the
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-400 mt-1">
                Your trusted retail consultancy
              </p>
            </div>
          ...
          <div className="mt-8 text-center text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Retail Partner. All rights
            reserved.
          </div>
        </div>
      </footer>
